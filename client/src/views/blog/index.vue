                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="(blog, index) in blogs" :key="blog.id">
                            <td>{{++index}}</td>
                            <td><img :src="'http://127.0.0.1:8000/storage/images/blogs/'+blog.cover" :alt="blog.judul" class="w-100"></td>
                            <td>{{blog.judul}}</td>
